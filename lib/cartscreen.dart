...
class _CartScreenState extends State<CartScreen> {
                                          ...
                                          Container(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CachedNetworkImage(
                                                ...
                                                imageUrl:  server + "images/${cartData[index]['code']}.jpg",
    ...
    http.post(urlLoadJobs, body: {
      ...
      setState(() {
        ...
        for (int i = 0; i < cartData.length; i++) {
          ...
          _totalquantity = int.parse(cartData[i]['cartquantity']) + _totalquantity;
        }
  ...
  void _updatePayment() {
    ...
    setState(() {
      for (int i = 0; i < cartData.length; i++) {
        _totalprice = double.parse(cartData[i]['yourprice']) + _totalprice;
        _totalquantity = int.parse(cartData[i]['cquantity']) + _totalquantity;
      }
      print(_selfPickUp);
      if (_selfPickUp) {
        deliverycharge = 0.0;
        ...
        if (_totalprice > 100) {
          ...
          deliverycharge = _totalquantity * 0.5;
        }
      }
      if (_homeDelivery) {
        if (_totalprice > 100) {
...
import 'package:watchyou/payment.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  void _loadCart() {
    ...
    http.post(urlLoadJobs, body: {
      ...
      setState(() {
        ...
        for (int i = 0; i < cartData.length; i++) {
          _totalquantity =
              int.parse(cartData[i]['cartquantity']) + _totalquantity;
          _totalprice = double.parse(cartData[i]['yourprice']) + _totalprice;
        }
  ...
  _updateCart(int index, String op) {
    ...
    http.post(urlLoadJobs, body: {
      //"email": widget.user.email,
      "productcode": cartData[index]['code'],
    ...
    setState(() {
      ...
      if (_selfPickup) {
        ...
        if (_totalprice > 100) {
          ...
          deliverycharge = _totalquantity * 5.0;
        }
      }
      if (_homeDelivery) {
        if (_totalprice > 100) {
